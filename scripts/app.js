...
// (hence the name of this Kata). The exclusive or evaluates two booleans. It then returns true if exactly one of the two expressions are 
// true, false otherwise. For example:
...
// we will use the "!=" not equal operator 
// if a and b are not equal then it returns true, but if they are equal then it returns false
function xor(a, b){
    return a != b;
}